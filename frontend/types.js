 ...
 * @typedef {{journey: JourneyPlan | null, total_duration_seconds: number | null, driving_seconds: number | null, pause_seconds: number | null, energy_stop_count: number | null, energy_consumption: number | null, distance_km: number, duration_seconds: number, payout_eur: number, operating_cost_eur: number, profit_eur: number, route_geojson: RouteGeometry, vehicle_id: string | null, operating_cost_eur_per_km: number}} Quote
 * @typedef {Omit<Quote, "operating_cost_eur_per_km" | "journey"> & {journey: JourneyPlan, origin_snapshot?: Hub, destination_snapshot?: Hub, id: string, vehicle_id: string, departed_at: number, arrives_at: number, origin: Hub, destination: Hub, contract: Contract}} Transport
 * @typedef {{journey: JourneyPlan, id: string, vehicle_id: string, model_id: string, model_name: string, username: string, player_color: string, is_own: boolean, departed_at: number, arrives_at: number, route_geojson: RouteGeometry}} PublicTransport
