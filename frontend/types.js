 ...
 * @typedef {{journey: JourneyPlan, progress: JourneyProgress | null, distance_km: number, routing_duration_seconds: number, provider: string, payout_eur: number, operating_cost_eur: number, profit_eur: number, route_geojson: RouteGeometry, origin_snapshot?: Hub, destination_snapshot?: Hub, id: string, vehicle_id: string, departed_at: number, arrives_at: number, origin: Hub, destination: Hub, contract: Contract}} Transport
