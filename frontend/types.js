 ...
 * @typedef {{cost_breakdown?: CostBreakdown | null, start?: Hub, approach_distance_km?: number, delivery_distance_km?: number, route_legs?: RouteLeg[], journey: JourneyPlan | null, total_duration_seconds: number | null, driving_seconds: number | null, pause_seconds: number | null, energy_stop_count: number | null, energy_consumption: number | null, distance_km: number, duration_seconds: number, payout_eur: number, operating_cost_eur: number, profit_eur: number, route_geojson: RouteGeometry, vehicle_id: string | null, maintenance_eur_per_km?: number}} Quote
 * @typedef {{policy_version: string, maintenance_eur_per_km: number, energy_kind: string, energy_unit: string, energy_price_eur_per_unit: number, base_cost_eur: number, maintenance_cost_eur: number, purchases: {segment_index: number, quantity: number, cost_eur: number}[], energy_cost_eur: number, total_cost_eur: number}} CostBreakdown
