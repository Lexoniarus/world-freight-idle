 ...
 * @typedef {{id: string, city: string, label: string, address: string, lat?: number, lon?: number, resolution_status?: string}} Hub
 * @typedef {{id: string, name: string, hub_id: string, capacity_tons: number, mode: string, status: string, hub: Hub, model_id?: string, image?: VehicleImage | null, operating_cost_eur_per_km?: number}} Vehicle
 * @typedef {{id: string, cargo: string, tons: number, mode: string, origin_hub_id: string, origin: Hub, destination: Hub, shipper_name: string, consignee_name: string}} Contract
 ...
 * @typedef {Omit<Quote, "operating_cost_eur_per_km"> & {id: string, vehicle_id: string, departed_at: number, arrives_at: number, origin: Hub, destination: Hub, contract: Contract}} Transport
 ...
 * @typedef {{vehicles: Vehicle[], contracts: Contract[], transports: Transport[]}} MapState
